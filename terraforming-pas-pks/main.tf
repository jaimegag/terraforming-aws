...
module "ops_manager" {
  ...
  use_route53              = "${var.use_route53}"
  additional_iam_roles_arn = ["${module.pas.iam_pas_bucket_role_arn}", "${module.pks.pks_worker_iam_role_arn}", "${module.pks.pks_master_iam_role_arn}"]
...
module "pks_certs" {
  ...
  ssl_cert           = "${var.pks_ssl_cert}"
  ssl_private_key    = "${var.pks_ssl_private_key}"
  ssl_ca_cert        = "${var.pks_ssl_ca_cert}"
  ssl_ca_private_key = "${var.pks_ssl_ca_private_key}"
}
